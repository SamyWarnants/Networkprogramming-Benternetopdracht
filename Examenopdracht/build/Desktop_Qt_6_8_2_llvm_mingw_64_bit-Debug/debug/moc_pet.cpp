...
static constexpr auto qt_meta_stringdata_ZN3PetE = QtMocHelpers::stringData(
    "Pet"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN3PetE[] = {
...
Q_CONSTINIT const QMetaObject Pet::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN3PetE.offsetsAndSizes,
    qt_meta_data_ZN3PetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN3PetE_t,
        // Q_OBJECT / Q_GADGET
...
void *Pet::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN3PetE.stringdata0))
